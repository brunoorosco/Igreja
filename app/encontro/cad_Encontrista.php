...
<head>
		...
		<link rel="stylesheet" type="text/css" href="../../_fonts/css/styles.css">
       ...
       <div class="container">
       	<div>
			...
			<form  id="ajax_form" action="" method="post" >
				...
				<div class="form-group">
				 	<input type="text" name="tel1" class="form-control tel" placeholder="Telefone ...." id="" required="">
				 </div>
				 <div class="form-group">
				 	<input type="text" name="tel2" class="form-control tel" placeholder="Telefone ...." id="" required="">
				 </div>
		...
		<script type="text/javascript" src="../../_fonts/js/script.js"></script>
