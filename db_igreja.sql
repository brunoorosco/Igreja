...
-- Copiando dados para a tabela db_igreja.aceita_jesus: ~135 rows (aproximadamente)
/*!40000 ALTER TABLE `aceita_jesus` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `aceita_jesus` ENABLE KEYS */;

-- Copiando dados para a tabela db_igreja.acessonew: ~37 rows (aproximadamente)
/*!40000 ALTER TABLE `acessonew` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `acessonew` ENABLE KEYS */;

-- Copiando dados para a tabela db_igreja.batizando: ~17 rows (aproximadamente)
/*!40000 ALTER TABLE `batizando` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `batizando` ENABLE KEYS */;

-- Copiando dados para a tabela db_igreja.cem: ~13 rows (aproximadamente)
/*!40000 ALTER TABLE `cem` DISABLE KEYS */;
INSERT INTO `cem` (`id`, `responsavel`, `endereco`, `nome_cem`) VALUES
	...
	(12, 95, '', 'kids'),
	(13, 46, '', 'Wagner/Rosana');
/*!40000 ALTER TABLE `cem` ENABLE KEYS */;

-- Copiando dados para a tabela db_igreja.config_sistem: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `config_sistem` DISABLE KEYS */;
INSERT INTO `config_sistem` (`id`, `funcao`, `_status`) VALUES
	(1, 'todos_membros', 's'),
	(2, 'filtro_membros', '2');
/*!40000 ALTER TABLE `config_sistem` ENABLE KEYS */;

-- Copiando dados para a tabela db_igreja.curso: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `curso` DISABLE KEYS */;
/*!40000 ALTER TABLE `curso` ENABLE KEYS */;

-- Copiando dados para a tabela db_igreja.encontrista: ~272 rows (aproximadamente)
/*!40000 ALTER TABLE `encontrista` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `encontrista` ENABLE KEYS */;

-- Copiando dados para a tabela db_igreja.encontro: ~272 rows (aproximadamente)
...
-- Copiando dados para a tabela db_igreja.equipe: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `equipe` DISABLE KEYS */;
/*!40000 ALTER TABLE `equipe` ENABLE KEYS */;

-- Copiando dados para a tabela db_igreja.eventos: ~11 rows (aproximadamente)
...
-- Copiando dados para a tabela db_igreja.historico: ~34 rows (aproximadamente)
/*!40000 ALTER TABLE `historico` DISABLE KEYS */;
INSERT INTO `historico` (`idHist`, `nome`, `status_`, `membroCad`, `curso`) VALUES
	(1, NULL, NULL, NULL, NULL),
	(2, 'BRUNO DO NASCIMENTO OROSCO', 'A', 179, NULL),
	(3, NULL, NULL, NULL, NULL),
	(4, NULL, NULL, NULL, NULL),
	(5, 'ADRIANA ALBUQUERQUE DE LIMA', 'R', NULL, NULL),
	(6, 'Ana Lucia Luz Orosco', 'R', NULL, NULL),
	(7, 'DENISE RIBEIRO DE JESUS LEITE', 'A', NULL, NULL),
	(8, 'CAMILLA CRISTINA AMORIM CARVALHO', 'A', NULL, NULL),
	(9, 'THIAGO DA SILVA GOMES', 'A', NULL, NULL),
	(10, '', 'A', NULL, NULL),
	(11, 'BRUNO DO NASCIMENTO OROSCO', 'R', NULL, NULL),
	(12, '', 'A', NULL, NULL),
	(13, 'BRUNO DO NASCIMENTO OROSCO', 'A', NULL, NULL),
	(14, '0', 'R', 31, NULL),
	(20, '0', 'R', 31, NULL),
	(21, 'jesse', 'R', NULL, NULL),
	(22, '0', 'R', 31, NULL),
	(23, '0', 'R', 31, NULL),
	(24, 'jesse', 'A', NULL, NULL),
	(25, '0', 'R', 151, NULL),
	(26, '0', 'R', 151, NULL),
	(27, '0', 'R', 151, NULL),
	(28, '0', 'A', 151, NULL),
...
-- Copiando dados para a tabela db_igreja.igrejas: ~1 rows (aproximadamente)
...
-- Copiando dados para a tabela db_igreja.infocursos: ~6 rows (aproximadamente)
/*!40000 ALTER TABLE `infocursos` DISABLE KEYS */;
INSERT INTO `infocursos` (`idCursos`, `nomeCursos`, `tema`, `data_`) VALUES
	(1, 'Escola de Profeta', 'Nossa Visão', '2019-03-12'),
	(2, 'Escola de Profetas', 'Angelologia', '2019-08-20'),
	(3, NULL, 'teologia', '2019-04-12'),
	(4, 'Escatologia', 'Escola de Profeta', '2018-12-11'),
	(5, 'Escola de Profeta', 'Simbologia', '2019-03-12'),
	(6, 'Discipulado', '', '2019-03-12');
/*!40000 ALTER TABLE `infocursos` ENABLE KEYS */;

-- Copiando dados para a tabela db_igreja.info_encontro: ~3 rows (aproximadamente)
/*!40000 ALTER TABLE `info_encontro` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `info_encontro` ENABLE KEYS */;

-- Copiando dados para a tabela db_igreja.info_reencontro: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `info_reencontro` DISABLE KEYS */;
/*!40000 ALTER TABLE `info_reencontro` ENABLE KEYS */;

-- Copiando dados para a tabela db_igreja.membros: ~230 rows (aproximadamente)
...
INSERT INTO `membros` (`idmembros`, `nome`, `nasc`, `endereco`, `telefone`, `supervisao`, `cargo`, `email`, `cadastro`, `igreja`) VALUES
	(2, 'Ana Lucia Luz Orosco', '1973-07-14', 'rua Gupeva, 56 Vila Curuça', '(11) 98355-5651', 'Lika', 'Líder', 'analu.luz@hotmail.com', '2019-02-02 19:47:10', 1),
	(16, 'Jaqueline Tavares de Souza', '1981-09-20', 'rua Castanheira do Brejo, 136', '(11) 94829-7524', 'Jaqueline', 'Supervisor', 'jaquelinesouza_2006@hotmail.com', '2019-03-02 18:19:40', 1),
	(17, 'Laércio Carlos de Lima', '1956-02-02', 'Avenida Ipê Roxo 1339 Jardim Jaragua', '(11) 94179-4640', 'Pr. Laércio/Vera', 'Pastor', 'laerciomkids@hotmail.com', '2019-03-02 18:22:20', 1),
	(18, 'DANIEL MORSE', '1969-06-16', 'RUA ANTONIO JOÃO DE MEDEREIROS,465 BLOCO 3 APTO 23', '(11) 97203-2556', 'Todas', 'Bispo', 'prdanielmorse@gmail.com', '2019-03-02 18:23:51', 1),
	(20, 'TARCILA DOS SANTOS FONSECA', '1983-12-09', 'RUA CASTANHEIRO DO BREJO 322', '(11) 98510-0508', 'WAGUERSON', 'Líder', 'TTARCILA.9FONSECA@HOTMAIL.COM', '2019-03-11 09:13:18', 1),
	(21, 'Martim Ramalho Vieira', '1980-12-28', 'Rua : Folha Dourada ,92', '(11) 95984-9430', 'Martim/Shirley', 'Supervisor', 'martimramalhovieira@gmail.com', '2019-03-15 13:00:54', 1),
	(22, 'Shirley Viviane Vieira', '1982-08-05', 'Rua : Folha Dourada ,92', '(11) 98261-1344', 'Martim/Shirley', 'Supervisor', 'shirley.viviane5@yahoo.com.br', '2019-03-15 13:26:21', 1),
	(23, 'Mirtes Barbosa da Silva ', '1970-01-01', 'Avenida caraipe das águas, 1171', '(11) 95159-176', 'Mirtes', 'Supervisor', 'Mirtesbs@hotmail.com', '2019-03-15 15:14:25', 1),
	(24, 'Carine Reis Torres ', '1986-12-29', 'Palha brava 222', '(11) 98255-1613', 'Mirtes', 'Líder', 'carine29.reis@hotmail.com', '2019-03-15 17:29:53', 1),
	(25, 'Sandra louriene Marques da silva', '1970-01-01', 'Rua caminho quatro,306 bloco H ap 31 Guarulhos ', '(11) 98443-0359', 'Mirtes ', 'Anfitrião', '.lindinhas2@hotmail.com', '2019-03-15 18:07:19', 1),
	(26, 'Ednilsa Araujo Gomes', '1978-07-30', 'Rua Angelo Frazilio, 360', '(11) 97370-2874', 'Casais', 'Pastor', 'adm_progresso@hotmail.com', '2019-03-19 14:28:51', 1),
	(31, 'BRUNO DO NASCIMENTO OROSCO', '1987-03-29', '', '(11) 94071-4391', 'Lika', 'Líder', 'brunoorosco@gmail.com', '2019-03-19 20:37:30', 1),
	(32, 'Leonardo Mauriz de Oliveira', '1980-02-28', 'Rua Guiraro, 173 - Ap 04 Bl A', '(11) 99289-1969', 'Casais', 'Auxiliar', 'newcar@autocenternewcar.com.br', '2019-03-20 10:10:20', 1),
	(33, 'Luana Dias Bezerra', '1983-08-08', 'Rua Guiraro 173 - Apto 04 Bl A', '(11) 98809-1166', 'Casais', 'Auxiliar', 'luanadiasguma@yahoo.com', '2019-03-20 10:11:24', 1),
	(34, 'Renata Gabriela da Silva Ramalho', '1994-09-26', 'Rua Eurides Fernandes do Nascimento, 504', '(11) 95483-7305', 'Casais', 'Auxiliar', 'renatta.gabii@gmail.com', '2019-03-20 10:12:45', 1),
	(35, 'Diogo Juan Ramalho Santos', '1988-07-16', 'Rua Eurides Fernandes do Nascimento, 504', '(11) 95873-2032', 'Casais', 'Líder', 'diogo.juan2@gmail.com', '2019-03-20 10:14:07', 1),
	(36, 'Jessica Santos de Oliveira', '1989-10-14', 'Rua Francisca Marinque Guerra, 72', '(11) 94893-0021', 'Casais', 'Líder', 'jessica.santos.oliv@gmail.com', '2019-03-20 10:15:04', 1),
	(37, 'Felipe Salustiano Soares', '1991-05-23', 'Rua Francisca Mairinque Guerra, 72', '(11) 94862-3271', 'Casais', 'Líder', 'felipe_salustiano@hotmail.com', '2019-03-20 10:16:06', 1),
	(38, 'Priscila Graziele dos Santos Magalhaes', '1986-01-30', 'Rua Antonio Joao de Medeiros, 758 Bl E Apt 52', '(11) 95916-1667', 'Casais', 'Auxiliar', 'priscilgraziele3@gmail.com', '2019-03-20 10:17:19', 1),
	(39, 'Marco Antonio Claro de Souza', '1984-11-14', 'Rua Joao Antonio de Medeiros, 758 Bl E Ap 52', '(11) 96649-8779', 'Casais', 'Líder', 'marco@agenciaskn.com.br', '2019-03-20 10:18:45', 1),
	(40, 'Dener Santos Luz', '1981-07-22', 'Rua Matheus Barbosa de Resende, 85 B', '(11) 94796-7754', 'Casais', 'Auxiliar', 'denerluz22@gmail.com', '2019-03-20 10:19:42', 1),
	(41, 'Michelly Ribeiro Luz', '1990-04-20', 'Rua Matheus Barbosa de Resende, 85 B', '(11) 94796-8710', 'Casais', 'Auxiliar', 'michellyribeiroluz@gmail.com', '2019-03-20 10:20:38', 1),
	(42, 'Alexsandro da Silva Gomes', '1974-02-26', 'Rua Joao Antonio de Medeiros, 65 Bl 4 Ap 13', '(11) 98796-2870', 'Casais', 'Líder', 'alx10@live.com', '2019-03-20 10:21:32', 1),
	(43, 'Edivania Ferreira Gomes', '1968-11-27', 'Rua Joao Antonio de Medeiros, 465 Bl 4 Ap 13', '(11) 95282-2404', 'Casais', 'Auxiliar', 'vaninha.fgomes@gmail.com', '2019-03-20 10:23:03', 1),
	(44, 'Erica Silva Santos', '1983-05-21', 'Rua Caraipe das Aguas, 207', '(11) 96155-2509', 'Casais', 'Supervisor', 'ericass_30santos@hotmail.com', '2019-03-20 10:24:34', 1),
	(45, 'Fabio Alexandre Silva Santos', '1979-05-19', 'Rua Caraipe das Aguas, 207', '(11) 96559-4424', 'Casais', 'Supervisor', 'fabinhoduipe@hotmail.com', '2019-03-20 10:25:26', 1),
	(46, 'WAGUERSON DE OLIVEIRA', '1971-12-14', 'RUA ENGENHO VELHO 238', '(11) 97490-0408', 'WAGUERSON', 'Supervisor', 'waguerson.oliveira@gmail.com', '2019-03-29 12:30:47', 1),
	(47, 'LILIAN BRITO GOMES DOS SANTOS', '2000-11-15', 'RUA JACAREANA 9', '(11) 95431-5963', 'WAGUERSON', 'Auxiliar', 'LILIAN18H@OUTLOOK.COM', '2019-03-29 12:53:32', 1),
	(48, 'FERNANDA ANDREIA DE LIMA GODOI', '1980-08-01', 'AV GUABA 98 B', '(11) 98732-1006', 'WAGUERSON', 'Líder', 'FERNANDA.LIMAGODOY01@GMAIL.COM', '2019-03-29 13:17:45', 1),
	(49, 'RODRIGO DOS SANTOS GODOI', '1981-01-04', 'AV GUABA 98 B', '(11) 98732-1006', 'WAGUERSON', 'Líder', 'RODRIGO.GODOY04@GMAIL.COM', '2019-03-29 13:18:57', 1),
	(50, 'VICTOR DE SIQUEIRA MOREIRA', '2000-02-02', 'RUA BALEEIRA BRANCA 12', '(11) 98390-7496', 'WAGUERSON', 'Líder', 'VICTORMOREIRA6055@GMAIL.COM', '2019-03-29 13:24:30', 1),
	(51, 'DANIELA DOS SANTOS TARDIOLLE', '1999-07-06', 'RUA PALMEIRA DAS BERMUDAS 1.374', '(11) 98390-7496', 'WAGUERSON', 'Auxiliar', 'PEDANIMA@GMAIL.COM', '2019-03-29 14:28:53', 1),
	(52, 'APARECIDA MARIA LUCIANO', '1970-01-01', 'RUA CAFE DO BRASIL 98', '(11) 98673-1380', 'WAGUERSON', 'Auxiliar', 'CIDA.LUCIANO59@HOTMAIL.COM', '2019-03-30 15:58:16', 1),
	(53, 'CARLA CRISTINA DOS SANTOS', '1970-01-01', 'RUA ANTENAS 52', '(11) 98286-5042', 'WAGUERSON', 'Auxiliar', 'CARLA_CRISTINASB@HOTMAIL.COM', '2019-03-30 15:59:48', 1),
	(54, 'ROSINEIDE TEREZINHA DE ANDRADE ', '1971-07-10', 'RUA JOÃO MESQUITA 33', '(11) 95983-6811', 'WAGUERSON', 'Auxiliar', 'ROSINEIDETEREZINHA10@GMAIL.COM', '2019-03-30 16:04:07', 1),
	(55, 'DAVID NUNES DOS SANTOS ', '1972-01-25', 'RUA JOÃO MESQUITA 33', '(11) 95983-6811', 'WAGUERSON', 'Auxiliar', 'DAVIDNUNESRDS@GMAIL.COM', '2019-03-30 16:05:15', 1),
	(56, 'JESSICA RODRIGUES DA SILVA ', '1970-01-01', 'RUA PALMEIRA DAS BERMUDAS 605', '(11) 97968-7888', 'WAGUERSON', 'Líder', 'JE.RODRIGUES.SILVA@HOTMAIL.COM', '2019-03-30 16:09:27', 1),
	(57, 'WALLACE CHRISTIAN M. DA SILVA ALVES ', '1998-08-01', 'RUA MÃE D\'AGUA 66', '(11) 97954-7741', 'WAGUERSON', 'Líder', 'WALLACECHRISTIAN35@GMAIL.COM', '2019-03-30 16:12:28', 1),
	(58, 'JAQUELINE DOS SANTOS OLIVEIRA', '1985-04-13', 'RUA MARIO MASINE 238', '(11) 95457-8026', 'WAGUERSON', 'Auxiliar', 'JAQUE1385@GMAIL.COM', '2019-03-30 16:17:00', 1),
	(59, 'LEANDRO RAMALHO NEIVA', '1987-12-26', 'RUA OSORIO FRANCO VILHENA 984', '(11) 95457-8026', 'WAGUERSON', 'Auxiliar', 'LEANDRORAMALHO8726@GMAIL.COM', '2019-03-30 16:19:12', 1),
	(60, 'RICARDO PINTO DE MORAES', '1976-12-26', 'RUA CASTANHEIRO DO BREJO 322', '(11) 98510-0508', 'WAGUERSON', 'Líder', 'RICARDOKAIKEKAUE@GMAIL.COM', '2019-03-30 16:34:33', 1),
	(61, 'ANA PAULA APARECIDA DA SILVA GODOI', '1988-06-09', 'RUA GUIRARO 331', '(11) 94958-5014', 'WAGUERSON', 'Auxiliar', 'ANAPAULA1_LINDA_GATINHA@HOTMAIL.COM', '2019-03-30 16:36:52', 1),
	(62, 'BRUNA CAROLINY DE SOUZA ', '1994-06-17', 'RUA DARCI MANO 213', '(11) 96070-9329', 'WAGUERSON', 'Líder', 'BCAROLINY1994@HOTMAIL.COM', '2019-03-30 16:48:17', 1),
	(63, 'MARIA LUIZA SABINO ', '1997-04-17', 'RUA MORRO DA BABILONIA 91', '(11) 96337-4497', 'WAGUERSON', 'Líder', 'MARIALUIZASABINO05@GMAIL.COM', '2019-03-30 16:54:34', 1),
	(64, 'KEVIN LEOPOLDINO KAMIA', '1996-08-01', 'RUA MORRO DA BABILONIA 91', '(11) 96337-4497', 'WAGUERSON', 'Auxiliar', 'KEVINHO_KLK@GMAIL.COM', '2019-03-30 16:56:18', 1),
	(65, 'DANIELA BATISTA LIRA', '1985-07-15', 'RUA CANTIDIANO GUIMARÃES 13', '(11) 96217-1001', 'WAGUERSON', 'Auxiliar', 'DANIELABATISTALIRA@GMAIL.COM', '2019-03-30 16:59:27', 1),
	(66, 'LETICIA MONTEIRO DA SILVA ', '1982-08-25', 'RUA BALEEIRA BRANCA 116', '(11) 98837-9936', 'WAGUERSON', 'Líder', 'S2LETICIA.SILVAS2@GMAIL.COM', '2019-04-01 13:20:58', 1),
	(67, 'SIMONE MARIANO DA SILVA ', '1973-06-28', 'RUA MÃE D´AGUA 66', '(11) 94960-8941', 'WAGUERSON', 'Líder', 'MARIANOSSIMONE@GMAIL.COM', '2019-04-01 13:23:46', 1),
	(68, 'MARIAH EDUARDA FERREIRA GOMES ', '2001-06-19', 'RUA ANTONIO JOÃO DE MEDEIROS 465', '(11) 94895-7737', 'WAGUERSON', 'Líder', 'MARIAH.EFGOMES@GMAIL.COM', '2019-04-01 13:28:40', 1),
	(69, 'GABRIEL BARUCH FERREIRA GOMES ', '2003-12-26', 'RUA ANTONIO JOÃO DE MEDEIROS 465', '(11) 94895-7737', 'WAGUERSON', 'Auxiliar', 'BARUCH.FERREIRA@GMAIL.COM', '2019-04-01 13:29:35', 1),
	(70, 'GUILHERME DA SILVA NASCIEMNTO', '2003-05-20', 'RUA BALIEIRA BRANCA 116', '(11) 99233-8082', 'WAGUERSON', 'Líder', 'GUILHERME29051996@GMAIL.COM', '2019-04-01 15:09:52', 1),
	(71, 'JOÃO SEVERINO DE SOUZA ', '1965-08-20', 'AV ALVARO DOS SANTOS MATOS 157', '(11) 97968-9629', 'WAGUERSON', 'Líder', 'JOAOSBOY@YAHOO.COM.BR', '2019-04-01 15:36:37', 1),
	(72, 'ADRIANA A. DE LIMA SOUZA', '1972-10-16', 'AV ALVARO DOS SANTOS MATOS 157', '(11) 97968-9629', 'WAGUERSON', 'Auxiliar', 'LIMA.DRI@YAHOO.COM.BR', '2019-04-01 15:49:21', 1),
	(76, 'ELIANA ALVES PEQUENO', '1968-07-07', 'R. Caraipes das Águas, 1816', '(11) 97381-9825', 'Lika', 'Supervisor', 'elianalikapequeno@gmail.com', '2019-04-04 20:20:20', 1),
	(77, 'CLARICE REGINA SANTOS PEQUENO', '1981-12-09', 'Rua Congonha do Sertao n 3', '(11) 95429-8133', 'Luizinho/Clarice', 'Supervisor', 'bia.clarice@yahoo.com.br', '2019-04-04 20:35:32', 1),
	(79, 'Marcus Vinicius Otoni de Morais', '1993-09-22', 'rua do pombo correio n 290', '(11) 98528-0170', 'Valdirene', 'Líder', 'marcus_otto@hotmail.com', '2019-04-04 20:43:31', 1),
	(80, 'Cláudio Silva Gomes ', '1975-07-19', 'Rua Ângelo Frazilio 360', '(11) 99710-9359', 'Casais', 'Pastor', 'rafa_gomes19@yahoo.com.br', '2019-04-04 20:46:21', 1),
	(81, 'Valdirene Oliveira Bispo dos Santos', '1969-02-25', 'rua faveira do igapo 274 fds', '(11) 97961-6246', 'Valdirene', 'Supervisor', 'valdireneclamor@yahoo.com.br', '2019-04-04 20:47:21', 1),
	(82, 'FABIO FRANCISCO', '1970-01-01', 'Rua Congonha do Sertao n 52', '(11) 99299-8995', 'Fabio/Sandra', 'Supervisor', 'franciscofabio705@hotmail.com', '2019-04-04 20:54:26', 1),
	(83, 'SANDRA  DANTAS SIQUEIRA FRANCISCO', '1970-01-01', 'Rua Congonha do Sertao n 52', '(11) 95861-8250', 'Fabio/Sandra', 'Supervisor', 'sandradantassiqueirafrancisco0@gmail.com', '2019-04-04 20:57:42', 1),
	(84, 'LUCAS ORSI', '1994-07-27', 'R. Caraipes das Águas, 1816', '(11) 98655-5716', 'Lika', 'Líder', 'lucasorsi95@gmail.com', '2019-04-04 21:05:20', 1),
	(85, 'Francildo Silva de Oliveira', '1968-02-23', 'av ipe roxo 1704', '(11) 97961-2622', 'Zô', 'Supervisor', 'francildo68f@gmail.com', '2019-04-04 21:10:37', 1),
	(86, 'Willian da Cunha Leao', '1984-02-28', 'rua ilha dos ratones 35', '(11) 94243-8311', 'Willian/Sumaria', 'Supervisor', 'willian.uei@hotmail.com', '2019-04-04 21:15:44', 1),
	(87, 'SUMARIA ALMEIDA LEAO', '1981-02-10', 'rua ilha dos ratones 35', '(11) 99332-1325', 'Willian/Sumaria', 'Supervisor', 'sumariacunha@hotmail.com', '2019-04-04 21:19:16', 1),
	(88, 'Eliane de Oliveira Cunha', '1979-07-06', 'Rua Agrimensor Sugaya 551 Ap 33 Bl-B', '(11) 97256-0467', 'Pr. Marcos/Eliane', 'Pastor', 'eliane.filo@bol.com.br', '2019-04-04 21:22:56', 1),
	(89, 'Marcos Silva da Cunha', '1974-12-20', 'Rua Agrimensor Sugaya 551 AP 33 BL -B', '(11) 97256-0467', 'Pr. Marcos/Eliane', 'Pastor', 'kakocunha48@gmail.com', '2019-04-04 21:25:30', 1),
	(90, 'Anderson Alves dos Santos', '1984-01-27', 'Rua Arnaldo Cintra, 190', '(11) 99887-9336', 'Pr. Anderson', 'Pastor', 'anderson.alves777@gmail.com', '2019-04-04 21:31:03', 1),
	(92, 'Wagner William Andrade de Matos', '1977-03-07', 'r. arvore de umbela, n. 143', '(11) 96393-6297', 'Itu', 'Pastor', 'aguia.bilhares@yahoo.com.br', '2019-04-04 21:36:17', 1),
	(93, 'Rosana Miranda da Silva Matos', '1967-05-28', 'r. arvore de umbela, n. 143', '(11) 96393-6297', 'Itu', 'Pastor', 'aguia.bilhares@yahoo.com.br', '2019-04-04 21:38:21', 1),
	(94, 'RITA DE CASSIA RIBEIRO', '1966-09-19', 'R MACAUBA MIRIM 233 ', '(11) 98225-8516', 'RITA', 'Supervisor', 'RI.AVIVAC@HOTMAIL.COM', '2019-04-04 21:49:41', 1),
	(95, 'Kelly Cristina Leopoldino kamiya', '1976-05-15', 'Rua morro da Babilônia 91', '(11) 91371-684', 'Kids', 'Supervisor', 'kelly.naoesquecerasenha@gmail.com', '2019-04-05 21:58:55', 1),
	(97, 'GISELLY RAMOS FERREIRA', '1993-08-03', 'RUA PROFESSOR ANTONIO DE CASTRO LOPES,517', '(11) 95488-0862', 'Zô', 'Líder', 'gisellygihrf@gmail.com', '2019-04-18 11:58:48', 1),
	(98, 'ALEX PEREIRA DE OLIVEIRA', '1988-10-03', 'RUA PROFESSOR ANTONIO DE CASTRO LOPES,517', '(11) 97754-7616', 'Zô', 'Líder', 'alexpereiradeoliveira88@hotmail.com', '2019-04-18 12:00:22', 1),
	(99, 'KAUE HENRIQUE RAMOS DE OLIVEIRA', '2010-06-08', 'RUA PROFESSOR ANTONIO DE CASTRO LOPES,517', '(11) 95488-0862', 'Zô', 'Membro', 'kauehrdeoliveira@gmail.com', '2019-04-18 12:06:08', 1),
	(100, 'ELIANE CRISTINA DE NEGREIROS OLIVEIRA ', '1979-11-09', 'RUA ITAJUIBE,2447 BLOCO D APTO 42', '(11) 99139-2889', 'Zô', 'Membro', 'eliane_negreiros@hotmail.com', '2019-04-18 13:44:47', 1),
	(101, 'ROSANGELA MARIA PEREIRA DIAS', '1982-05-03', 'RUA POMBO CORREIO,11', '(11) 95998-2396', 'Zô', 'Líder', 'rosangelamaria-03@hotmail.com', '2019-04-18 14:10:59', 1),
	(102, 'RUBENS SOUZA MAIA ', '1978-05-29', 'RUA DO POMBO CORREIO,11', '(11) 95497-3126', 'Zô', 'Líder', 'rosariaequipamentos@hotmail.com', '2019-04-18 14:13:37', 1),
	(103, 'WILSON PEREIRA DE OLIVEIRA ', '1986-06-25', 'RUA JOSE ALEXANDRE MACHADO,552', '(11) 98309-7687', 'Zô', 'Líder', 'wil.son25@hotmail.com', '2019-04-18 14:15:33', 1),
	(104, 'ESTER PEREIRA DE SOUZA DIAS', '2011-01-25', 'RUA DO POMBO CORREIO,11', '(11) 95998-2396', 'Zô', 'Membro', 'bekinha2029@gmail.com', '2019-04-18 14:17:46', 1),
	(105, 'RAFAELA PEREIRA DE OLIVEIRA ', '2015-06-25', 'RUA JOSE ALEXANDRE MACHADO 552', '(11) 98309-7687', 'Zô', 'Membro', 'rfamodel@gmail.com', '2019-04-18 14:19:40', 1),
	(106, 'GRACE KELLY LEILA DE OLIVEIRA', '1989-06-12', 'RUA JOSE ALEXANDRE MACHADO,552', '(11) 98330-6371', 'Zô', 'Líder', 'gklo1225@gmail.com', '2019-04-18 14:22:01', 1),
	(107, 'DENISE RIBEIRO DE JESUS LEITE', '1988-06-08', 'RUA FRANCISCA MANRIQUE GUERRA,394', '(11) 95985-9404', 'Zô', 'Líder', 'deniseribeiro88@gmail.com', '2019-04-18 14:24:26', 1),
	(108, 'SUELI RIBEIRO GARCIA', '1978-10-16', 'RUA CARAIPE DAS AGUAS ,872', '(11) 99913-3626', 'Zô', 'Líder', 'suelirs.garcia@gmail.com', '2019-04-18 14:26:31', 1),
	(109, 'GUSTAVO RIKELMY RIBEIRO VIEIRA ', '2003-09-01', 'RUA CARAIPE DAS AGUAS ,872', '(11) 99913-3626', 'Zô', 'Auxiliar', 'gu.rikelmy@hotmail.com', '2019-04-18 14:28:23', 1),
	(110, 'ELISÂNGELA SANTOS DE OLIVEIRA ', '1989-12-14', 'RUA PEROBA ROSA,303', '(11) 95114-0756', 'Zô', 'Líder', 'elisangelaso@gmail.com', '2019-04-18 14:31:01', 1),
	(111, 'SIMONE RIBEIRO DA SILVA ', '1977-09-17', 'RUA CARAIPE DAS AGUAS ,887', '(11) 95844-5785', 'Zô', 'Auxiliar', 'somoneribeiro@gmail.com', '2019-04-18 14:32:32', 1),
	(112, 'STEPHANIE RODRIGUES SANTOS RAMALHO', '1992-12-07', 'RUA CAFE BRASIL,71', '(11) 95954-6723', 'Zô', 'Líder', 'teca_ag@hotmail.com', '2019-04-18 14:35:16', 1),
	(113, 'ROGERIO OLIVEIRA DOS SANTOS', '1977-08-17', 'RUA ISABEL MORALES DE OLIVEIRA,476', '(11) 98544-5758', 'Zô', 'Auxiliar', 'rogerio.oliveirasantos@hotmail.com', '2019-04-18 14:37:29', 1),
	(114, 'ANDREIA PEREIRA FLORINDO', '1972-06-04', 'RUA LOURENÇO DA VEIGA,161', '(11) 98475-5875', 'Zô', 'Líder', 'andreia.florindo234@hotmail.com', '2019-04-18 14:39:25', 1),
	(115, 'TAYNA RIBEIIRO DE OLIVEIRA ', '2002-09-17', 'RUA CARAIPE DAS AGUAS ,887', '(11) 95876-2548', 'Zô', 'Membro', 'taynaribeiro234@gmail.com', '2019-04-18 14:41:16', 1),
	(116, 'ALEDXSSANDER DE OLIVEIRA ', '1979-01-17', 'RUA BELISARIO BENITEZ, 276', '(11) 96986-5874', 'Zô', 'Líder', 'alexssanderabencoado@hotmail.com', '2019-04-18 14:44:30', 1),
	(117, 'LAIS ALVEZ ', '1986-11-14', 'AVENIDA PAPA JOAO PAULO1,4020', '(11) 95875-4862', 'Zô', 'Membro', 'lais.mayumi1@gmail.com', '2019-04-18 14:46:09', 1),
	(118, 'MARIA CRISTINA RIBEIRO DE OLIVEIRA', '1973-07-13', 'RUA BELISARIO BENITEZ, 276', '(11) 94578-5265', 'Zô', 'Líder', 'mcristinaoliveira@hotmail.com', '2019-04-18 14:47:19', 1),
	(119, 'JULIA RIBEIRO SOUZA ', '2005-09-12', 'RUA BELISARIO BENITEZ, 276', '(11) 95428-6808', 'Zô', 'Auxiliar', 'juliaju1209@hotmail.com', '2019-04-18 15:20:48', 1),
	(120, 'PAULO SANTOS DE OLIVEIRA', '2013-07-08', 'RUA PEROBA ROSA,303', '(11) 95848-7528', 'Zô', 'Membro', 'paulosantos@gmail.com', '2019-04-18 15:21:57', 1),
	(121, 'PEDRO SANTOS DE OLIVEIRA ', '2013-07-08', 'RUA PEROBA ROSA,303', '(11) 98548-7512', 'Zô', 'Membro', 'pedrosantos@gmail.com', '2019-04-18 15:22:48', 1),
	(122, 'GLAIDE SANTOS PONTE SALVATO', '1982-01-26', 'RUA JOSIMAR CERQUEIRA,22', '(11) 96582-4587', 'Zô', 'Auxiliar', 'gsps@gmail.com', '2019-04-18 15:25:36', 1),
	(123, 'MAGAIVER LEITE RIBEIRO', '1986-11-27', 'RUA FRANCISCA MARINQUE GUERRA, 594', '(11) 99958-6485', 'Zô', 'Auxiliar', 'magaiverleite1770@gmail.com', '2019-04-18 15:27:39', 1),
	(124, 'ELAINE CRISTINA DE NEGREIROS OLIVEIRA ', '1979-11-09', 'RUA ITAJUIBE,2447 BLOCO D APTO 42', '(11) 99139-2889', 'Zô', 'Membro', 'elaine_negreiros@hotmail.com', '2019-04-18 15:28:18', 1),
	(125, 'ELIANE SOARES DOS SANTOS ', '1969-04-26', 'RUA KAMPALA PENHA,55', '(11) 98548-7548', 'Zô', 'Líder', 'eliane.soares@hotmail.com', '2019-04-18 15:30:55', 1),
	(126, 'JENIFFER CASTRO DOS SANTOS', '2005-05-17', 'RUA KAMPALA PENHA,55', '(11) 96585-4852', 'Zô', 'Membro', 'jenicastro@gmail.com', '2019-04-18 15:32:49', 1),
	(127, 'EMILI CASTRO DOS SANTOS ', '2005-05-17', 'RUA KAMPALA PENHA,55', '(11) 95845-7552', 'Zô', 'Membro', 'EMICASTRO@GMAIL.COM', '2019-04-18 15:34:32', 1),
	(128, 'ELENILSON SANTOS', '1995-12-02', 'RUA KAMPALA,55', '(11) 98854-8752', 'Zô', 'Membro', 'ELENILSOONST@HOTMAIL.COM', '2019-04-18 15:35:50', 1),
	(129, 'ELIELSOM SANTOS', '1995-12-25', 'RUA KAMPALA,55', '(11) 98852-5457', 'Zô', 'Membro', 'ELISANTOS@HOTMAIL.COM', '2019-04-18 15:37:30', 1),
	(130, 'FERNANDO FELIS DA SILVA', '1978-02-03', 'RUA OSORIO FRANCO VILHEMA,953', '(11) 95625-8754', 'Zô', 'Auxiliar', 'FERNANDOFELIS38@GMAL.COM', '2019-04-18 15:39:40', 1),
	(131, 'ANA DINA SANTOS DE NEGREIROS', '1953-02-21', 'RUA JOSE ELEUTERIO DOS SANTOS ,252', '(11) 98548-7224', 'Zô', 'Líder', 'ANADINANEGREIROS@GMAIL.COM', '2019-04-18 15:41:19', 1),
	(132, 'KATY GARCIA ', '1995-01-21', 'RUA JARDIM DAS MARGARIDAS,272', '(11) 98623-5478', 'Zô', 'Auxiliar', 'KATY-MARGARIDA@HOTMAIL.COM', '2019-04-18 15:42:56', 1),
	(133, 'AGATHA RODRIGUES SILVA', '2006-02-03', 'RUA CAFE BRASIL,71', '(11) 95648-8802', 'Zô', 'Membro', 'agathas@gmail.com', '2019-04-18 15:44:43', 1),
	(134, 'GUILHERME HENRIQUE RODRIGUES SILVA', '2009-09-12', 'RUA CAFE BRASIL ,71', '(11) 95458-2457', 'Zô', 'Membro', 'gui.henrique@gmil.com', '2019-04-18 15:46:24', 1),
	(135, 'MARIO LUIZ DOS SANTOS RAMALHO RODRIGUES', '1988-10-31', 'RUA CAFE BRASIL.71', '(11) 98956-2873', 'Zô', 'Líder', 'marioramalho@icloud.com', '2019-04-18 15:47:45', 1),
	(136, 'PAMELA APARECIDA PIARETI DE NEGREIROS', '1989-12-05', 'RUA JOSE ELEUTERIO DOS SANTOS,252', '(11) 97754-8254', 'Zô', 'Líder', 'piaretipamela@gmail.com', '2019-04-18 15:49:54', 1),
	(137, 'RODRIGO HENRIQUE DE NEGREIROS ', '1986-01-29', 'RUA JOSE ELEUTERIO DOS SANTOS,252', '(11) 95482-6574', 'Zô', 'Líder', 'rodrigohnegreiros@yahoo.com.br', '2019-04-18 15:51:42', 1),
	(138, 'SUÉLEN ALMEIDA SANTOS', '1993-11-25', 'RUA BORBOLETA AMARELA,210 JD HELENA', '(11) 94875-5105', 'Valdirene', 'Membro', 'suelen.25.santos@gmail.com', '2019-04-19 22:50:51', 1),
	(139, 'VINICIUS DE ASSIS SOUZA', '2003-08-01', 'RUA PROFESSOR ASSIS VELOSO,SÃO MIGUEL', '(11) 95148-8145', 'Valdirene', 'Membro', 'vini.souza.2014@hotmail.com', '2019-04-19 23:15:13', 1),
	(140, 'DIEGO AUGUSTO DE SOUZA', '1992-02-26', 'RUA AMORA,JD IPE', '(11) 98867-3248', 'Valdirene', 'Membro', 'diegoaugustosouza18@gmail.com', '2019-04-19 23:31:01', 1),
	(141, 'ANDREONE FELIPE FONSECA', '1994-05-17', 'RUA CRESCENTE,295 JD BARTIRA', '(11) 95444-6656', 'Valdirene', 'Membro', 'andreonefonseca@outlook.com', '2019-04-19 23:33:24', 1),
	(142, 'LUCIMAR LOURDES DE MORAIS', '1959-09-02', 'RUA DO POMBO CORREIO,290 JD IPE', '(11) 95913-5582', 'Valdirene', 'Líder', 'lucmarl.morais@hotmail.com', '2019-04-19 23:51:15', 1),
	(143, 'SABRINA SOUZA DE OLIVEIRA', '1999-12-17', 'RUA DUILIO LERNADUZZI,448 VL PARANAGUÁ', '(11) 95068-4703', 'Valdirene', 'Líder', 'sabrina.souza00@outlook.com', '2019-04-19 23:53:53', 1),
	(144, 'ANDERSON OLIVEIRA BISPO DOS SANTOS', '1999-03-21', 'RUA FAVEIRA DO IGAPO 274 JD IPE', '(11) 95454-4210', 'Valdirene', 'Líder', 'aobs_2010@hotmail.com', '2019-04-19 23:56:19', 1),
	(145, 'CLÉCIOMARCIO FRANCISCO DA SILVA', '1998-08-02', 'RUA OLIVIA COELHO MARTINS,447 JD MAIA', '(11) 95253-0407', 'Valdirene', 'Líder', 'cleciomarcio.junior@outlook.com', '2019-04-20 00:00:25', 1),
	(146, 'JOYCE GABRIELA CARVALHO RIBEIRO', '2007-02-02', 'PALMEIRA DAS BERMUDAS JD IPE', '(11) 96874-4101', 'Valdirene', 'Auxiliar', 'lucianaribeiroosilva@gmail.com', '2019-04-20 00:12:50', 1),
	(147, 'LUSIMAR MARIA SILVA', '1957-10-15', 'RUA PALMEIRA DAS BERMUDAS 826,JD IPE', '(11) 94680-6729', 'Valdirene', 'Auxiliar', 'lusimarmaria1957@hotmail.com', '2019-04-20 00:16:26', 1),
	(148, 'GUSTAVO  HENRIQUE CARVALHO RIBEIRO', '2007-02-02', 'RUA PALMEIRA DAS BERMUDAS 826 JD IPE', '(11) 94680-6729', 'Valdirene', 'Auxiliar', 'lucianaribeiroosilva@gmail', '2019-04-20 00:20:04', 1),
	(149, 'GABRIELE OLIVEIRA BISPO DOS SANTOS', '2004-03-17', 'RUA FAVEIRA DO IGAPO 274 JD IPE', '(11) 98535-0217', 'Valdirene', 'Auxiliar', 'gabirene2004@gmail.com', '2019-04-20 00:23:28', 1),
	(151, 'GELSON BISPO DOS SANTOS', '1993-04-10', 'AV.MARECHAL TITO 3097 ITAIM PTA', '(11) 95968-5362', 'Valdirene', 'Líder', '', '2019-04-23 12:05:56', 1),
	(152, 'RINALDO LORASQUE ', '1968-04-07', 'AV IGARAPES 1285 JD IPE', '(11) 98240-2702', 'Valdirene', 'Líder', 'Rinaldolorasque@bendsteel.com.br', '2019-04-23 23:29:19', 1),
	(153, 'teste edicao', '1970-01-01', 'teste teste', '(11)12344-4444', 'Lika', 'Supervisor', 'supervisor@supervisor', '2019-05-02 12:49:26', 1),
	(154, 'THAUANE MELISSA COSTA MOREIRA', '1995-03-28', 'SERAFINA D \'ABRIL,61', '(11) 98700-2145', 'Quatro Seres', 'Líder', 'thauane.melissa@gmail.com', '2019-05-10 21:51:39', 1),
	(155, 'COSME DE JESUS JUNIOR', '1993-01-20', 'Jose Martins Lisboa 2168', '(11) 96463-8498', 'Lika', 'Membro', 'cosmedejesusjunior93@gmail.com', '2019-05-13 23:00:20', 1),
	(156, 'CLEICE ALVES DA SILVA ', '1980-03-02', 'AV. DOS IPÊS 1376', '(11) 98450-2913', 'Lika', 'Líder', 'cleicealsilvaped@hotmail.com', '2019-05-13 23:21:39', 1),
	(157, 'ALBENIZE MELO', '1974-02-19', 'AV JOSÉ MARTINS LISBOA 2179', '(11) 96545-0812', 'Lika', 'Auxiliar', 'Melo.albenize@hotmail.com', '2019-05-13 23:29:58', 1),
	(158, 'ROBERTO BORGES BONFIM ', '1981-05-05', 'Jequirana de goias 515  ', '(11) 96452-2132', 'Lika', 'Membro', 'Robertbborges@81.com.br', '2019-05-13 23:55:03', 1),
	(159, 'ROQUE THOME DE OLIVEIRA', '1960-03-08', 'RUA ARICANGA 1252', '(11) 96693-4040', 'Lika', 'Auxiliar', 'lucasorsi@live.com', '2019-05-13 23:58:25', 1),
	(160, 'IVANILDE SILVA SANTOS DE OLIVEIRA', '1964-08-03', 'RUA ARICANGA 1252', '(11) 97778-6674', 'Lika', 'Auxiliar', 'lucasorsi1@live.com', '2019-05-14 00:00:29', 1),
	(161, 'GABRIELA EDUARDA GOMES DE SOUZA', '1993-09-01', 'RUA ROSA MUSGO, 25 A', '(11) 98151-4877', 'Lika', 'Auxiliar', 'gabriela.gsbio@gmail.com', '2019-05-14 00:33:18', 1),
	(162, 'ÂNGELA MUZEL DA SILVA   ', '1961-12-22', 'Antônio cação 58 ', '(11) 94893-3703', 'Lika', 'Auxiliar', 'lucasorsi2@live.com', '2019-05-14 00:37:27', 1),
	(163, 'MARIELE CHAGAS DA SILVA', '1986-09-02', 'MELCHIADES NERES DE CAMPOS 120', '(11) 94981-0992', 'Lika', 'Líder', 'marielichagasdasilvabela@gmil.com', '2019-05-14 00:41:55', 1),
	(164, 'Marcos Antônio da Silva', '1981-04-29', 'Melchiades Neres de Campos 120', '(11) 96149-6037', 'Lika', 'Líder', 'marielichagasdasilvabela2@gmil.com', '2019-05-14 00:46:10', 1),
	(165, 'Camily Janaina Chagas da Silva', '2003-07-15', 'Melchiades Neres de Campos 120', '(11) 96973-7840', 'Lika', 'Auxiliar', 'marielichagasdasilvabela3@gmil.com', '2019-05-14 00:49:52', 1),
	(166, 'VANESSA CRISTINA DA SILVA ', '1970-01-01', 'RUA ANTÔNIO CAÇÃO 85', '(11) 95467-8626', 'Lika', 'Membro', 'NESSA.PITTY68@GMAIL.COM', '2019-05-14 11:06:26', 1),
	(167, 'ADRIANA ALBUQUERQUE DE LIMA', '1978-03-31', 'Rua', '(11) 98543-2751', 'Lika', 'Auxiliar', 'dribruna@hotmail.com', '2019-05-14 11:08:28', 1),
	(168, 'SHEILA DA SILVA HENRIQUE', '1981-05-18', 'RUA ANTÔNIO CAÇÃO 85', '(11) 95986-9437', 'Lika', 'Auxiliar', 'Sheila.henrique@atento.com.br', '2019-05-14 11:10:14', 1),
	(169, 'LEANDRO BATISTA DA SILVA', '1983-09-07', 'Palmeira das bermudas 128 ', '(11) 98153-3432', 'Lika', 'Líder', NULL, '2019-05-14 11:38:29', 1),
	(172, 'TAMAR PEREIRA DANTAS DE LIMA', '1985-09-22', 'Rua Folha Dourada 62', '(11) 98736-2088', 'Lika', 'Líder', 'tamar.pereira@yahoo.com.br', '2019-05-14 12:12:50', 1),
	(173, 'FELIPE ZWIR', '1988-01-08', 'RUA GUAIUVIRA 121', '(11) 96258-8075', 'Lika', 'Membro', 'felipezwir@hotmail.com', '2019-05-14 13:39:00', 1),
	(174, 'BRUNA RODRIGUES DOS SANTOS', '1992-03-05', 'RUA PARAITINGA 336', '(11) 95828-6450', 'Lika', 'Líder', 'BRUNABILLY_@HOTMAIL.COM', '2019-05-14 13:41:14', 1),
	(175, 'CHRISTOPHER BATISTA DOS SANTOS ', '1992-03-19', 'RUA PARAITINGA 336', '(11) 98632-6089', 'Lika', 'Líder', 'lucasorsi1@gmail.com', '2019-05-14 13:43:43', 1),
	(176, 'TATIANE OLIVEIRA SILVA ', '1981-04-18', 'RUA NOTURNO MINEIRO 22', '(11) 97211-3352', 'Lika', 'Líder', 'TATIA_NENE@HOTMAIL.COM', '2019-05-14 13:46:41', 1),
	(177, 'CARLOS EDUARDO RODRIGUES XAVIER ', '1987-07-14', 'RUA NOTURNO MINEIRO 22', '(11) 99981-1767', 'Lika', 'Membro', 'CEDUARDU@HOTMAIL.COM', '2019-05-14 13:53:00', 1),
	(178, 'CARMEM LUCIA S. FARIAS', '1964-04-19', 'DIAS DE ÁVILA 10', '(11) 98987-6612', 'Lika', 'Líder', 'carmem.s.farias@hotmail.com', '2019-05-14 16:08:24', 1),
	(179, 'JOSÉ  MARCOS DE OLIVEIRA FARIAS', '1964-01-25', 'DIAS DE ÁVILA 10', '(11) 98160-9159', 'Lika', 'Líder', 'j.marcos64@Outlook.com', '2019-05-14 16:10:29', 1),
	(180, 'MARIA DAS DORES SILVA ', '1976-07-22', 'PALMEIRAS DAS BERMUDAS 128', '(11) 97803-3550', 'Lika', 'Membro', 'naotememail@gmail.com', '2019-05-14 16:18:04', 1),
	(181, 'RODRIGO SILVA SANTANA ', '2001-10-28', 'PALMEIRAS DAS BERMUDAS 128', '(11) 96833-7169', 'Lika', 'Membro', 'naotem.email@gmail.com', '2019-05-14 16:19:34', 1),
	(182, 'LÍDIA CANDIDO B. SILVA ', '1985-01-16', 'PALMEIRAS DAS BERMUDAS 128', '(11) 98153-3432', 'Lika', 'Auxiliar', 'nao.tem.email@gmail.com', '2019-05-14 16:21:11', 1),
	(183, 'MATEUS FERNANDES ', '2008-04-12', 'GUAIUVIRA 121', '(11) 96258-8075', 'Lika', 'Auxiliar', 'naotememail1@gmail.com', '2019-05-14 16:23:02', 1),
	(184, 'PATRICIA FERNANDES ', '1977-03-20', 'GUAIUVIRA 121', '(11) 96258-8075', 'Lika', 'Líder', 'naotem.email2@gmail.com', '2019-05-14 16:24:22', 1),
	(185, 'NICOLAS DA SILVA CRISTIA', '2005-10-30', 'RUA ANTÔNIO CAÇÃO 85', '(11) 95986-9437', 'Lika', 'Membro', 'naotememail3@gmail.com', '2019-05-14 16:26:58', 1),
	(186, 'JORGE SILVA FILHO', '1973-11-06', 'BERNADINO SILVA 6', '(11) 96736-1007', 'Lika', 'Líder', 'naotememail4@hotmail.com', '2019-05-14 16:35:02', 1),
	(187, 'AGATHA CHRISTYE DE LIMA SOUZA', '1999-02-18', 'AV.ALVARO DOS SANTOS MATTOS,157, PQ SANTA RITA ', '(11) 99444-4345', 'Quatro Seres', 'Auxiliar', 'AGATHALIMASOUZA@GMAIL.COM', '2019-05-14 16:42:01', 1),
	(188, 'GISLAINE RIBEIRO ', '1995-05-10', 'RUA MACAUBA MIRIM,233- JARDIM DOS PES ', '(11) 95439-7967', 'Quatro Seres', 'Membro', 'GIH.NERES19@HOTMAIL.COM', '2019-05-14 17:10:07', 1),
	(189, 'WELDER ALVES DE ALMEIDA', '1998-02-17', 'RUA CONGONHA DO SERTÃO,52-JARDIM DOS YPES', '(11) 94233-5332', 'Quatro Seres', 'Membro', 'welderalves.bass@gmail.com', '2019-05-14 17:22:37', 1),
	(190, 'CAMILA ALVES DE CASTRO', '1970-01-01', 'RUA DOUTOR FRANCISCO TANCREDI,789- PQ PAULISTANO', '(11) 94971-5323', 'Quatro Seres', 'Membro', 'camila_silvaesilva@hotmail.com', '2019-05-14 17:36:37', 1),
	(192, 'GABRIEL PEREIRA CAXIAS ', '1994-08-09', 'RUA ASCENSO FERNANDES, 297- PQ PAULISTANO', '(11) 95202-8871', 'Quatro Seres', 'Membro', 'gabs.caxias7@gmail.com', '2019-05-14 17:39:45', 1),
	(193, 'LUIS CLAUDIO BORGES DA SILVA', '1994-04-16', 'RUA COQUEIRO CARANDÁ,352- JARDIM DOS YPES', '(11) 96591-8021', 'Quatro Seres', 'Membro', 'luis_zinho@live.com', '2019-05-14 17:44:54', 1),
	(194, 'THIAGO DA SILVA GOMES', '1986-03-24', 'AV.ALVARO DOS SANTOS MATTOS,151, PQ SANTA RITA ', '(11) 98393-7839', 'Quatro Seres', 'Supervisor', 'tgmesnre@gmail.com', '2019-05-14 17:47:47', 1),
	(195, 'EDSON MOREIRA COSTA', '1969-12-12', 'AV FERNANDO FIGUEIREDO LINS 38', '(11) 98565-0736', 'Lika', 'Líder', 'edymc33@hotmail.com', '2019-05-14 21:30:31', 1),
	(196, 'ELLEN MAYARA FEITOSA DA COSTA', '2003-07-13', 'AV FERNANDO FIGUEIREDO LINS 38', '(11) 96777-8015', 'Lika', 'Auxiliar', 'ellencosta1203@gmail.com', '2019-05-14 21:33:37', 1),
	(197, 'SÔNIA CLOTILDE FEITOSA DA COSTA', '1964-04-17', 'AV FERNANDO FIGUEIREDO LINS 38', '(11) 96686-4621', 'Lika', 'Auxiliar', 'soniafc174@gmail.com', '2019-05-14 21:36:47', 1),
	(200, 'JOEL SANTOS', '1980-04-30', 'Rua. Cairapes das Aguas', '(11) 97101-7977', 'Pr. Joel/Regiane', 'Pastor', 'joel.santos@novelis.com ', '2019-05-21 11:50:47', 1),
	(201, 'MAGNA DE OLIVEIRA SILVA ALVES', '1984-08-18', 'RUA ARNALDO CINTRA, 190', '(11) 99507-1196', 'Pr. Anderson', 'Supervisor', 'magna_osilva@yahoo.com.br', '2019-06-01 20:00:48', 1),
	(202, 'CLARICE REGINA SANTOS PEQUENO', '1981-12-09', 'RUA CONGONHAS DO SERTAO, 3', '(11) 95924-8133', 'Luizinho/Clarice', 'Supervisor', 'bia.clarice@yahoo.com.br', '2019-06-01 20:03:32', 1),
	(205, 'ADNA MELO', '1999-11-04', 'AV: JOSÉ MARTINS LISBOA', '(11) 94898-2394', 'Jaqueline', 'Auxiliar', '', '2019-06-01 21:57:01', 1),
	(206, 'SUELLEN  DE JESUS SILVA', '1998-08-27', 'AV: JOÃO BATISTA SANTIAGO,523', '(11) 99391-8515', 'Jaqueline', 'Membro', 'suellen383@gmail.com', '2019-06-01 22:02:15', 1),
	(207, 'ISABELE REGINA DE FRANÇA', '2007-09-22', 'RUA CONGONHAS DO SERTAO, 3', '(11) 95924-8133', 'Luizinho/Clarice', 'Membro', 'isabele.regina.f@hotmail.com', '2019-06-01 22:03:26', 1),
	(208, 'MATEUS LIMA MARTINS', '2000-06-26', 'RUA MORRO DA BABILONIA,27', '(11) 94933-3861', 'Jaqueline', 'Líder', 'limamartinsff@gmail.com', '2019-06-01 22:04:10', 1),
	(210, 'AMANDA MELO', '2000-12-24', 'RUA SARGENTO BASÍLIO M. DE SANTANA', '(11) 95967-8937', 'Jaqueline', 'Auxiliar', 'amandapereira349@gmail.com', '2019-06-01 22:09:10', 1),
	(211, 'MATEUS LIMA MARTINS', '2000-06-26', 'RUA MORRO DA BABILONIA ,27', '(11) 94933-3861', 'Jaqueline', 'Líder', 'limamartinsff@gmail.com', '2019-06-01 22:11:31', 1),
	(214, 'ANDRÉ LUIZ', '1992-08-29', 'AV: JOSÉ MARTINS LISBOA', '(11) 95972-1857', 'Jaqueline', 'Líder', '', '2019-06-01 22:14:45', 1),
	(215, 'ALDENIZE MELO', '1994-09-07', 'AV: JOSÉ MARTINS LISBOA,2179 A', '(11) 96524-1415', 'Jaqueline', 'Líder', '', '2019-06-01 22:16:16', 1),
	(216, 'CLAUDIANE ROSEMERE DE OLIVEIRA', '1988-08-15', 'RUA MASATO SAKAI,180', '(11) 94029-1684', 'Jaqueline', 'Auxiliar', '', '2019-06-01 22:17:47', 1),
	(217, 'CLAYZER DOS SANTOS', '1980-04-24', 'RUA MANAJÓS,26', '(11) 95401-6690', 'Jaqueline', 'Líder', '', '2019-06-01 22:19:25', 1),
	(218, 'DAVID DE JESUS SILVA ', '1994-10-19', 'AV: JOÃO BATISTA SANTIAGO,523', '(11) 98666-3630', 'Jaqueline', 'Líder', '', '2019-06-01 22:20:55', 1),
	(219, 'DIEGO OLIVEIRA DA SILVA', '1990-02-09', 'RUA BERLIN DE AZEVEDO VIEIRA,06', '(11) 99398-4414', 'Jaqueline', 'Líder', '', '2019-06-01 22:23:11', 1),
	(220, 'JANAINA TAVARES DE SOUZA', '1983-10-26', 'RUA ISABEL MORALES DE O.M.,696A', '(11) 95119-4336', 'Jaqueline', 'Líder', '', '2019-06-01 22:24:12', 1),
	(221, 'JEAN MICHEL', '1986-08-01', 'RUA MASATO SAKAI,180', '(11) 94032-6399', 'Jaqueline', 'Membro', '', '2019-06-01 22:25:51', 1),
	(222, 'JOYCE SOARES ', '1990-07-10', 'RUA JOÃO BATISTA SANTIAGO,523', '(11) 94819-2377', 'Jaqueline', 'Líder', '', '2019-06-01 22:27:31', 1),
	(223, 'LEILIANE OLIVEIRA DOS SANTOS', '1982-03-03', 'RUA MANAJÓS,26', '(11) 96216-6338', 'Jaqueline', 'Auxiliar', '', '2019-06-01 22:29:17', 1),
	(224, 'LIVIA FERNANDA SOUZA', '1991-05-26', 'RUA GUAPIRA,881', '(11) 95704-2429', 'Jaqueline', 'Líder', '', '2019-06-01 22:30:23', 1),
	(228, 'LUIZ FERNANDO MANZANI', '1986-02-19', 'RUA PIMENTA D\'ÁGUA,188', '(11) 94845-4104', 'Jaqueline', 'Líder', 'nandoavivanoiva@gmail.com', '2019-06-01 22:36:07', 1),
	(229, 'LUIS HENRIQUE LIMA GAIOT', '2003-07-02', 'RUA PARREIRA BRAVA,315', '(11) 95357-7482', 'Jaqueline', 'Membro', 'luish747474@gmail.com', '2019-06-01 22:39:18', 1),
	(230, 'MARIA DE FATIMA SANTOS DA SILVA', '1970-01-01', 'RUA LOURO TINGA,387', '(11) 93144-3215', 'Jaqueline', 'Membro', '', '2019-06-01 22:41:17', 1),
	(231, 'VIVIANE OLIVEIRA DA SILVA', '1982-08-29', 'RUA PEROBA ROSA,49', '(11) 99836-5125', 'Jaqueline', 'Membro', '', '2019-06-01 22:42:32', 1),
	(232, 'MARIA DE FATIMA SANTOS DA SILVA', '1968-01-13', 'RUA LOURO TINGA,387', '(11) 93144-3215', 'Jaqueline', 'Membro', '', '2019-06-01 22:43:21', 1),
	(237, 'KLARICE OLIVEIRA DOS SANTOS', '2011-07-27', 'RUA MANAJÓS,26', '(11) 96216-6338', 'Jaqueline', 'Membro', '', '2019-06-01 23:19:41', 1),
	(238, 'JHONATAN OLIVEIRA DOS SANTOS', '2016-07-27', 'RUA MANAJÓS,26', '(11) 96216-6338', 'Jaqueline', 'Membro', '', '2019-06-01 23:20:31', 1),
	(239, 'SARA REGINA GOMES XAVIER', '1997-09-05', 'RUA JOAO FRANCO DOS REIS,26', '(11) 96552-0228', 'Luizinho/Clarice', 'Auxiliar', 'sara@tubelab.tv', '2019-06-01 23:43:38', 1),
	(240, 'SONIA REGINA GOMES XAVIER', '1964-07-31', 'RUA JOAO FRANCO DOS REIS,26', '(11) 96903-9850', 'Luizinho/Clarice', 'Auxiliar', 'sonia86202070@gmail.com', '2019-06-01 23:45:25', 1),
	(241, 'ROGERIO SOARES DA SILVA', '1968-07-28', 'RUA CASTANHEIRA DO BREJO, 84', '(11) 97069-0241', 'Luizinho/Clarice', 'Membro', 'juridicorogerio@ig.com.br', '2019-06-01 23:50:31', 1),
	(243, 'CAROLINE ADOLFO KOVALINKINAS', '1981-12-10', 'RUA MONTE AZUL PAULISTA, 120', '(11) 95405-2603', 'Luizinho/Clarice', 'Membro', '', '2019-06-01 23:56:37', 1),
	(247, 'MANOEL MARCOS BEZERRA AMERICO', '1994-03-17', 'RUA MONTE AZUL PAULISTA, 120', '(11) 98253-3099', 'Luizinho/Clarice', 'Membro', '', '2019-06-01 23:58:50', 1),
	(253, 'CAMILLA CRISTINA AMORIM CARVALHO', '1990-03-12', 'RUA : CARMO DE MINAS ,32', '(11) 94972-8550', 'Martim/Shirley', 'Líder', 'camilacarvalho750@gmail.com', '2019-06-04 17:31:30', 1),
	(254, 'SAMUEL SANTOS CARVALHO', '1982-10-24', 'RUA : CARMO DE MINAS ,32', '(11) 94984-5811', 'Martim/Shirley', 'Líder', 'samuelcarvalho750@gmail.com', '2019-06-04 17:34:45', 1),
	(255, 'EDIVALDO ANTÔNIO OLIVEIRA', '1981-11-09', 'RUA: CARNANI ,31', '(11) 94022-6092', 'Martim/Shirley', 'Anfitrião', '', '2019-06-04 18:13:08', 1),
	(256, 'ELAINE NOGUEIRA OLIVEIRA', '1981-08-07', 'RUA: CARNANI ,31', '(11) 94444-7558', 'Martim/Shirley', 'Anfitrião', '', '2019-06-04 18:14:56', 1),
	(257, 'BIANCA NOGUEIRA OLIVEIRA', '2002-04-01', 'RUA: CARNANI ,31', '(11) 98043-3674', 'Martim/Shirley', 'Anfitrião', '', '2019-06-04 18:16:31', 1),
	(258, 'ADALBERTO ANTÔNIO DE OLIVEIRA', '1974-08-24', 'RUA: GUARAPARIBA ,434', '(11) 94088-4181', 'Martim/Shirley', 'Anfitrião', 'elizabethvitoria.ecceo@gmail.com', '2019-06-04 18:58:49', 1),
	(259, 'ELISABETE CRISTINA CONCEIÇÃO', '1992-08-24', 'RUA: GUARAPARIBA ,434', '(11) 96273-3079', 'Martim/Shirley', 'Membro', 'elizabethvitoria.ecceo@gmail.com', '2019-06-04 19:01:12', 1),
	(260, 'MISLENE GOMES DE OLIVEIRA', '1987-04-05', 'RUA: GUARAPARIBA ,434', '(11) 97991-3310', 'Martim/Shirley', 'Anfitrião', 'mislenegomes28@gmail.com', '2019-06-04 19:03:49', 1),
	(261, 'ELAINE GOMES DE OLIVEIRA', '1981-11-09', 'RUA: GUARAPARIBA ,434', '(11) 94728-6824', 'Martim/Shirley', 'Anfitrião', 'Elaine20014@mail.com', '2019-06-04 19:15:01', 1),
	(263, 'MAGDA RAMALHO VILAÇA', '1976-11-05', 'RUA: CARAIPES DAS ÁGUAS , 509', '(11) 98082-7581', 'Martim/Shirley', 'Líder', '', '2019-06-05 01:19:32', 1),
	(264, 'JOÃO HALISSON OLIVEIRA', '1976-12-27', 'RUA: LAGOA CAJUBA ,101', '(11) 96742-5690', 'Martim/Shirley', 'Líder', 'halisson_3051@hotmail.com', '2019-06-05 01:22:49', 1),
	(265, 'ELAINE CARDOSO OLIVEIRA', '1980-03-25', 'RUA: LAGOA CAJUBA ,  101', '(11) 98031-2261', 'Martim/Shirley', 'Auxiliar', 'elaine.c.s2009@hotmail.com', '2019-06-05 01:26:14', 1),
	(266, 'ANDERSON JOSÉ DA SILVA FERRARI', '1979-05-25', 'AV.IPE ROXO,493 JD IPE', '(11) 97682-9149', 'Valdirene', 'Líder', 'andersilvaferrari@gmail.com', '2019-06-06 22:40:42', 1),
	(267, 'VANESSA FERRARI DA SILVA', '1979-11-21', 'AV.IPE ROXO,493 JD IPE', '(11) 96588-1295', 'Valdirene', 'Líder', 'vanesferrari@hotmail.com', '2019-06-06 22:42:32', 1),
	(268, 'MÁRCIA RAMALHO VIEIRA SANTOS', '1970-04-25', 'RUA: CIPÓ DO REINO ,85', '(11) 95106-6977', 'Martim/Shirley', 'Líder', 'maravisa10@bol.com.br', '2019-06-07 12:58:49', 1),
	(269, 'DORIVAL PEREIRA DOS SANTOS', '1957-08-09', 'RUA: CIPÓ DO REINO ,85', '(11) 97806-6024', 'Martim/Shirley', 'Líder', 'maravisa10@bol.com.br', '2019-06-07 13:03:09', 1),
	(270, 'DORIVAL PEREIRA DOS SANTOS', '1957-08-09', 'RUA: CIPÓ DO REINO ,85', '(11) 97806-6024', 'Martim/Shirley', 'Líder', '', '2019-06-07 13:05:05', 1),
	(271, 'ROSÂNGELA SALVADOR DOS SANTOS', '1985-01-16', 'RUA: CIPÓ DO REINO ,85', '(11) 94539-7316', 'Martim/Shirley', 'Líder', 'angelassgabriel160185@gmail.com', '2019-06-07 13:12:07', 1),
	(272, 'DAVID RAMALHO DOS SANTOS', '1991-11-02', 'RUA: CIPÓ DO REINO ,85', '(11) 94539-7316', 'Martim/Shirley', 'Líder', 'drscorintiano@bol.com.br', '2019-06-07 13:14:58', 1),
	(273, 'DAYANE APARECIDA DE JESUS', '2002-01-20', 'RUA DAS GAIVOTAS, 06 -  VALE DAS BRISAS', '(11) 95322-5288', 'Prs Wagner/Rosana', 'Membro', '953225288dayane@gmail.com', '2019-06-12 17:28:27', 1),
	(274, 'DANIELA SANTOS DE JESUS', '1984-12-06', 'VALE DAS BRISAS, RUA DAS GAIVOTAS N°06', '(11) 95038-3374', 'Prs Wagner/Rosana', 'Membro', '', '2019-06-12 17:56:32', 1),
	(275, 'NILTON HENRIQUE LIMA JUNIOR', '1983-02-08', 'VALE DAS BRISAS, RUA DAS GAIVOTAS N°06', '(11) 94211-8878', 'Prs Wagner/Rosana', 'Membro', '', '2019-06-12 17:57:56', 1),
	(276, 'DAYANE APARECIDA DE JESUS DA FONSECA', '2002-01-20', 'VALE DAS BRISAS, RUA DAS GAIVOTAS N°06', '(11) 95322-5288', 'Prs Wagner/Rosana', 'Membro', '953225288dayane@gmail.com', '2019-06-12 17:59:55', 1),
	(277, 'MARIA VITORIA JESUS DA FONSECA', '2005-09-26', 'VALE DAS BRISAS, RUA DAS GAIVOTAS N°06', '(11) 95038-3374', 'Prs Wagner/Rosana', 'Membro', '', '2019-06-12 18:01:01', 1),
	(278, 'ANA FLAVIA RAMOS DA SILVA', '2002-03-31', 'VALE DAS BRISAS, RUA DAS ANDORINHAS N°8585', '(11) 93024-2262', 'Prs Wagner/Rosana', 'Membro', 'ANAFLAVIARAMOS068@GMAIL.COM', '2019-06-12 18:07:06', 1),
	(279, 'ANA CAROLINA RAMOS DA SILVA', '2007-03-28', 'VALE DAS BRISAS, RUA DAS ANDORINHAS N°8585', '(11) 99481-4378', 'Prs Wagner/Rosana', '', '', '2019-06-12 18:11:14', 1),
	(280, 'ANA PAULA RAMOS DA SILVA FERREIRA', '1993-03-20', 'VALE DAS BRISAS, RUA DAS ANDORINHAS Nº83', '(11) 97351-8500', 'Prs Wagner/Rosana', 'Membro', '', '2019-06-12 18:17:15', 1),
	(281, 'ALEXANDRE APARECIDO FERREIRA', '1977-05-20', 'VALE DAS BRISAS, RUA DAS ANDORINHAS N°83', '(11) 97351-8500', 'Prs Wagner/Rosana', 'Membro', '', '2019-06-12 18:19:20', 1),
	(282, 'MARIA FERREIRA SAISA', '1951-11-05', 'VALE DAS BRISAS, RUA DAS GAIVOTAS ', '(11) 95029-7736', 'Prs Wagner/Rosana', 'Membro', '', '2019-06-12 18:23:53', 1),
	(283, 'MATHEUS RIBEIRO SILVA DE MEDEIROS', '2004-07-14', 'ENTRADA MUNICIPAL DA SERVIDÃO, Nº6854-9-VAREJÃO', '(11) 95308-2532', 'Prs Wagner/Rosana', 'Membro', 'MATHEUSRIBEIRO4002@GMAIL.COM', '2019-06-12 18:32:59', 1);
/*!40000 ALTER TABLE `membros` ENABLE KEYS */;

-- Copiando dados para a tabela db_igreja.nivel_acesso: ~6 rows (aproximadamente)
...
-- Copiando dados para a tabela db_igreja.reencontrista: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `reencontrista` DISABLE KEYS */;
/*!40000 ALTER TABLE `reencontrista` ENABLE KEYS */;

-- Copiando dados para a tabela db_igreja.reencontro: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `reencontro` DISABLE KEYS */;
/*!40000 ALTER TABLE `reencontro` ENABLE KEYS */;

-- Copiando dados para a tabela db_igreja.tarefas_equipe: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `tarefas_equipe` DISABLE KEYS */;
/*!40000 ALTER TABLE `tarefas_equipe` ENABLE KEYS */;

-- Copiando dados para a tabela db_igreja.teste: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `teste` DISABLE KEYS */;
/*!40000 ALTER TABLE `teste` ENABLE KEYS */;

-- Copiando dados para a tabela db_igreja.turma: ~0 rows (aproximadamente)
